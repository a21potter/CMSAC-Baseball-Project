...
batters_vector <- unique(statcast_data_minus_2020_2022$batter)
...
```{r}
init_statcast_data_rf <- ranger(woba ~ ., data = statcast_data_minus_2020_2022, num.trees = 500, importance = "impurity")
