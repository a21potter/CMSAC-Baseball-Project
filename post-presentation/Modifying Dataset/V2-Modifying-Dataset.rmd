...
V2_statcast_data <- V2_statcast_data[ , colSums(is.na(statcast_data_combined)) < nrow(statcast_data_combined)]
...
statcast_data_combined_at_bats <- V2_statcast_data %>%
...
```{r}
write_rds(V2_statcast_data, glue("V2_data/V2_statcast_data_modified.rds"), compress = "gz")
```
