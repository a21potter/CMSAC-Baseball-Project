...
# Right-handed model
```{r}
init_logistic_model_R <- glm(on_base_binary ~ 
                             pitch_count*general_fielding_alignment +
                             general_pitch_type*general_fielding_alignment +
                             general_pitch_type*prop_pitch_type_hit_per_atbat+
                             general_pitch_type*prop_pitch_zone_per_atbat+
...
unique(V2_modeling_R$p_throw)
```

# Left-handed model
```{r}
init_logistic_model_L <- glm(on_base_binary ~ 
                             pitch_count*general_fielding_alignment +
                             general_pitch_type*general_fielding_alignment +
                             general_pitch_type*prop_pitch_type_hit_per_atbat+
                             general_pitch_type*prop_pitch_zone_per_atbat+
