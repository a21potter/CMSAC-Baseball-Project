...
rbind(prop_shift_left, prop_shift_right) %>%
  ...
  labs(title = "Shifting Trends Since 2015", x = "Year", y = "Proportion of Shifted PAs",
       color = "Stand")
```
...
***Confidence Interval for Infield-In***
...
***Confidence Interval for Traditional Alignment***
