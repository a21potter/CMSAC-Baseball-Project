...
As of yet, our modeling largely has inconclusive results. ______

Because of the motivation of this project being inference rather that predictability, many of our questions were touched upon through our exploration of the data. Especially since we were concerned with the differences between the outcomes of shifting for right-handed and left-handed batters, by plotting various trends over time we were able to visualize patterns.
