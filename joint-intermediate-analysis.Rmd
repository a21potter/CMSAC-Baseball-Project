...
- Filtered out Exhibition and Spring Training games
...
## Remove Fielding Arangement NAs

- Based on percent missingness, all observations with NA for IF or OF fielding arangements are removed
...
- Proportion of plays where these circumstances occur
